...
export const zh = {
  ...
  'input.toolsMode': '权限',
  'input.commands': '命令',
  'input.permission.readOnly': '只读',
  'input.permission.workspaceWrite': '工作区写入',
  'input.permission.fullAccess': '完全访问',
  'upload.button': '上传文件',
  'upload.pending': '正在解析文件…',
  'upload.unsupportedType': '支持 PNG、JPG、WebP、GIF、PDF、DOCX、TXT、MD、CSV、JSON 格式的文件',
  'upload.parseFailed': '文件无法解析，请确认文件未损坏且包含可读取的文本',
  'upload.emptyDocument': '文件中没有可读取的文本；扫描件请直接上传图片',
  'upload.remove': '移除文件 {name}',
  'input.stop': '停止生成',
  'input.send': '发送消息',
...
export const en = {
  ...
  'input.tools': 'Tools',
  'input.toolsMode': 'Mode',
  'input.commands': 'Commands',
  'input.permission.readOnly': 'Read Only',
  'input.permission.workspaceWrite': 'Workspace Write',
  'input.permission.fullAccess': 'Full access',
  'upload.button': 'Upload file',
  'upload.pending': 'Parsing file…',
  'upload.unsupportedType': 'PNG, JPG, WebP, GIF, PDF, DOCX, TXT, MD, CSV, and JSON files are supported',
  'upload.parseFailed': 'This file could not be parsed. Check that it is intact and contains readable text',
  'upload.emptyDocument': 'This file has no readable text. Upload source images for scanned documents',
  'upload.remove': 'Remove file {name}',
