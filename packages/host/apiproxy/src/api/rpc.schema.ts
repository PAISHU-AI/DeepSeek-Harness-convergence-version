...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-file-invalid'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  z.object({ code: z.literal('workspace-file-not-found'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  z.object({ code: z.literal('workspace-file-too-large'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string(), maxBytes: z.number() }) }),
  z.object({ code: z.literal('workspace-file-unsupported'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
