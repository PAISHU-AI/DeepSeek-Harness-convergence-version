...
export interface RpcErrorDetailsMap {
  ...
  'workspace-file-invalid': { workspaceId: string; path: string }
  'workspace-file-not-found': { workspaceId: string; path: string }
  'workspace-file-too-large': { workspaceId: string; path: string; maxBytes: number }
  'workspace-file-unsupported': { workspaceId: string; path: string }
