...
export interface IApiClient {
  ...
  workspace: {
    ...
    openFile(payload: RequestPayload<'workspace.openFile'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.openFile'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'workspace.openFile': workspaceOpenFileValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    openFile: (payload, signal) => this.callUnary('workspace.openFile', payload, signal),
    writeFile: (payload, signal) => this.callUnary('workspace.writeFile', payload, signal),
  }
