...
import {
  ...
  workspaceOpenFileRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.readFile': { schema: workspaceReadFileRequestSchema, invoke: (api, r) => api.workspace.readFile(r) },
  'workspace.openFile': { schema: workspaceOpenFileRequestSchema, invoke: (api, r, signal) => api.workspace.openFile(r, signal) },
  'workspace.writeFile': { schema: workspaceWriteFileRequestSchema, invoke: (api, r) => api.workspace.writeFile(r) },
